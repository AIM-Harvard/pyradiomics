...
#        maskName = dataDir + self.patientID + os.path.sep + 'TestPatient1_BreastMRI-Pre_labelMap-subvolume.nrrd'
        imageName = dataDir + 'TestPatient1_BreastMRI-Pre-subvolume.nrrd'
        maskName = dataDir + 'TestPatient1_BreastMRI-Pre_labelMap-subvolume.nrrd'
