...
def main():
    ...
    if args.volumeReconstructor == "plastimatch":
        ...
        scriptlogger.error(
            "Unknown option for volume reconstruction: %s. Allowed values are plastimatch and dcm2niix.")
        return -1
    ...
    for inputSegment in inputSegments:
        ...
        try:
            ...
            scriptlogger.error(
                'Initialization of the pyradimics feature extraction failed.:' + str(e))
            return -1
    ...
    m.m["SeriesDescription"] = segmentationMetadataAccessor.getSeriesDescription() + \
