        ...
        with open(outputFile, "wb") as outFile:
            ...
            for _patientIndex, patientDirectory in enumerate(datasetHierarchyDict):
                ...
                for studyDirectory in datasetHierarchyDict[patientDirectory]:
                    ...
                    imageFilepaths = datasetHierarchyDict[patientDirectory][
                        studyDirectory
                    ]["reconstructions"]
                    maskFilepaths = datasetHierarchyDict[patientDirectory][
                        studyDirectory
                    ]["segmentations"]

                    imageFilepath, maskFilepath = datasetReader.findImageAndLabelPair(
                        imageFilepaths, maskFilepaths, keywordSettings
                    )
